...
void I2C_Master_Devantech_ISS::Write(unsigned char addr, unsigned char nbytes, const unsigned char data[])
{
  /*  if(nbytes <= 0)
...
void I2C_Master_Devantech_ISS::WriteRegister(unsigned char addr, unsigned char reg, unsigned char nbytes,
...
void I2C_Master_Devantech_ISS::Read(unsigned char addr, unsigned char nbytes, unsigned char data[])
{
  /*  unsigned char buf[3];
...
void I2C_Master_Devantech_ISS::ReadRegister(unsigned char addr, unsigned char reg, unsigned char nbytes,
                                            unsigned char data[])
{
  unsigned char buf[4];
  // this is how the Devantech USB-I2C device normally expects communication to
