...
void I2C_Master_MPSSE::Write(unsigned char addr, unsigned char nbytes, const unsigned char data[])
{
  throw Except(__HERE__, "Write not implemented, use WriteRegister");
}

void I2C_Master_MPSSE::WriteRegister(unsigned char addr, unsigned char reg, unsigned char nbytes,
...
void I2C_Master_MPSSE::Read(unsigned char addr, unsigned char nbytes, unsigned char data[])
{
  throw Except(__HERE__, "Read not implemented, use ReadRegister");
}

void I2C_Master_MPSSE::ReadRegister(unsigned char addr, unsigned char reg, unsigned char nbytes, unsigned char data[])
{
  char txbuff[2];
  char *rxbuff = 0;
  txbuff[1] = reg;
